...
def can_be_found_updated_and_saved
  ...
  changed_film = Movie.find_by(title: "Awesome Flick")
  changed_film.update(title: "Even Awesomer Flick")
  changed_film.save
end
...
def can_update_using_update_method
  ...
  new_film = Movie.find_by(title: "Wat?")
  new_film.update(title: "Wat, huh?")
end
